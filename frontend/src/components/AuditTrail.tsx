...
function AuditItem({
  ...
  return (
    <li className="relative pl-8">
      ...
      {!isLast && (
        <span
          className="absolute left-[17px] top-5 h-[calc(100%-8px)] w-px bg-ink-200"
          aria-hidden
        />
      )}
      ...
      <div className="pb-6">
        <div className="flex flex-wrap items-center gap-2">
          <span
            className={`inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium ${style.chip}`}
          >
    ...
    <section className="card card-pad flex flex-col gap-5">
      <div>
        ...
        <p className="mt-0.5 text-sm text-ink-500">
          Recent RecoverAI activity and decisions
        </p>
      </div>
